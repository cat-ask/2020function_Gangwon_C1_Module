<div id="visual">
            <input type="radio" name="slidebtn" hidden="hidden" id="slide-1" checked>
            ...
            <div id="slide">
                <img src="resources/images/slide2.jpg" class="slide_img" id="slide_img2" alt="slide_img2">
                <img src="resources/images/slide3.jpg" class="slide_img" id="slide_img3" alt="slide_img3">
                <img src="resources/images/slide1.jpg" class="slide_img" id="slide_img1" alt="slide_img1">
            </div>
            <div id="slide_word">
                ...
                <div class="slide_word_box" id="slide2_word_box">
                    <h2>와일드한 <span>음식</span>과 <span>옛 추억</span>이 함께 어우러진 <span>축제</span></h2>
                    <p>완주의 풍요로운 산과 들, 하천에서 발견한 놀거리, 볼거리, 먹거리를<br>우리 아이들과 함께 체험하며 즐길 수 있는 소중한 기회!!<br>완주와일드푸드축제에 놀러오세요~</p>
                </div>
                <div class="slide_word_box" id="slide3_word_box">
                    <h2>모두가 <span>함께</span> 즐기는 즐거운 축제</h2>
                    <p>지역주민이 직접 준비한 다양한 볼거리와 체험거리 그리고<br>차별화된 먹거리를 제공하는 지역주민과 오시는 분 모두가 행복한 축제!</p>
                </div>
            </div>
            <div id="slide_link">
